...
def list_planilha_patrimonio(request):
    ...
    if chk_patrimonio_vazio == '1':
        ...
        inventario = Carga_inventario.objects.all().select_related('patrimonio_model', 'patrimonio_model__entidade_procedencia', 'patrimonio_model__equipamento', 'patrimonio_model__equipamento__especificacao', 'patrimonio_model__equipamento__entidade_fabricante')
