...
class TestPatrimonioComEquipamenpoVazio(TestCase):
    ...
    def test_equipamento_vazio(self):
        ...
        patr1 = Patrimonio.objects.create(part_number="", modelo="m2", descricao="", tipo=tipo1, equipamento=eq,
                                          checado=True)
    ...
    def test_descricao_diferente(self):
        ...
        patr1 = Patrimonio.objects.create(part_number="pt1", modelo="pt1", descricao="desc1", tipo=tipo1,
                                          equipamento=eq1, checado=True)
        patr2 = Patrimonio.objects.create(part_number="pt2", modelo="pt2", descricao="", tipo=tipo1,
    ...
    def test_tamanho_diferente(self):
        ...
        patr1 = Patrimonio.objects.create(part_number="pt1", modelo="pt1", descricao="pt1", tamanho=1.0,
                                          tipo=tipo1, equipamento=eq1, checado=True)
        patr2 = Patrimonio.objects.create(part_number="pt2", modelo="pt2", descricao="pt2", tipo=tipo1,
                                          equipamento=eq2, checado=True)
