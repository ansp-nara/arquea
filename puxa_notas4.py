...
cheques = []
termo = Termo.objects.get(ano=2005)
...
for l in dados:
	...
	try:
	    ...
	    pgto.reembolso = True
	    try:
                pgto.membro = Membro.objects.get(nome__startswith=pagamento[5].lstrip().rstrip())
            except:
	        print pagamento[5]
