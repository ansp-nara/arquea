...
class PesquisaAdmin(admin.ModelAdmin):
    ...
    #search_fields = ('protocolo__identificacao__entidade__sigla', 'protocolo__identificacao__entidade__nome', 'item_pedido__natureza_gasto__modalidade__sigla', 'item_pedido__natureza_gasto__modalidade__nome', 'protocolo__termo__ano', 'protocolo__termo__processo', 'protocolo__num_documento', 'protocolo__tipo_documento__nome', 'protocolo__descricao', 'valor_despesa', 'referente')
